		...
		liefern.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent e) {
				...
				Kontakt neuerKontakt = new Kontakt(vorname.getText(), nachname.getText(), plz.getText(),
						straﬂe.getText(), ort.getText(), telefon.getText(), email.getText(), warenkorb.getWarenkorb());
				...
				try {
					String sql = "INSERT INTO user (vorname) VALUES('"+vorname+"')";
					st = con.createStatement();
//					st.executeUpdate("ALTER TABLE user ADD COLUMN nachname VARCHAR(15) AFTER vorname;");
